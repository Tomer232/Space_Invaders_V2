...
class Game:
    def __init__(self):
        ...
        self.live_surface = pygame.image.load(
            'C:\\Users\\tomer\\Desktop\\Projects\\Space_InvadersV2\\visuals\\player.png').convert_alpha()
        self.live_x_start_pos = screen_width - (self.live_surface.get_size()[0] * 2 + 20)
        self.score = 0
        self.font = pygame.font.Font(
            'C:\\Users\\tomer\\Desktop\\Projects\\Space_InvadersV2\\font\\PixelifySans-VariableFont_wght.ttf', 20)
        ...
        self.obstacle_x_positions = [num * (screen_width / self.obstacles_amount) for num in
                                     range(self.obstacles_amount)]
    ...
    def display_lives(self):
        for lives in range(self.lives - 1):
            x = self.live_x_start_pos + (lives * (self.live_surface.get_size()[0] + 10))
